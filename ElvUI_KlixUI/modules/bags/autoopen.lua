...
--	[119000]	 = true, -- Highmaul Lockbox -- Lockpicking
	...
	[163857]     = true, -- Azerite Armor Cache
	[164579]     = true, -- Cache of Uldir Treasures
	[167026]     = true, -- Cache of Crucible Treasures
	[165724]     = true, -- Cache of Dazar'alor Treasures
	[164577]     = true, -- Warfronts Equipment Cache (Horde)
	[164578]     = true, -- Warfronts Equipment Cache (Alliance)
	[164251]     = true, -- Champion's Strongbox (Horde)
	[138469]     = true, -- Champion's Strongbox (Horde)
	[164252]     = true, -- Champion's Strongbox (Alliance)
	[138473]	 = true, -- Champion's Strongbox (Alliance)
	[141069]	 = true, -- Skyhold Chest of Riches
	[156682]	 = true, -- Otherworldly Satchel of Helpful Goods
	[156698]	 = true, -- Tranquil Satchel of Helpful Goods - Level 80
	[156689]	 = true, -- Scorched Satchel of Helpful Goods - Level 80
	[114655]	 = true, -- Scorched Satchel of Helpful Goods - Level 84
	[114662]	 = true, -- Tranquil Satchel of Helpful Goods - Level 85
	[114669]	 = true, -- Tranquil Satchel of Helpful Goods - Level 88
	[156688]	 = true, -- Tranquil Satchel of Helpful Goods - Level 70
	[156683]	 = true, -- Satchel of Helpful Goods - Level 50
	[51999]	 	 = true, -- Satchel of Helpful Goods - Level 1
	[135546]	 = true, -- Fel-Touched Crate of Battlefield Goods - Level 100 PvP Reward
	[135545]	 = true, -- Savage Crate of Battlefield Goods - Level 100 PvP Reward
	[164261]	 = true, -- Steel Strongbox (Alliance) - Level 100 PvP Reward
	[164264]	 = true, -- Steel Strongbox (Alliance) - Level 100 PvP Reward
	[165714]	 = true, -- Gold Strongbox (Alliance) - Level 100 PvP Reward
	[165715]	 = true, -- Silver Strongbox (Alliance) - Level 100 PvP Reward
	[165716]	 = true, -- Bronze Strongbox (Alliance) - Level 100 PvP Reward
	[165717]	 = true, -- Steel Strongbox (Alliance) - Level 100 PvP Reward
	[165718]	 = true, -- Steel Strongbox (Horde) - Level 100 PvP Reward
	[164262]	 = true, -- Steel Strongbox (Horde) - Level 100 PvP Reward
	[164263]	 = true, -- Steel Strongbox (Horde) - Level 100 PvP Reward
	[165711]	 = true, -- Gold Strongbox (Horde) - Level 100 PvP Reward
	[165712]	 = true, -- Silver Strongbox (Horde) - Level 100 PvP Reward
	[165713]	 = true, -- Bronze Strongbox (Horde) - Level 100 PvP Reward
	[138098]	 = true, -- Iron-Bound Crate of Battlefield Goods - Level 70 PvP Reward
	[135544]	 = true, -- Tranquil Crate of Helpful Goods - Reuse Me - Level 110 PvP Reward
	[135543]	 = true, -- Rival's Crate of Battlefield Goods - Level 110 PvP Reward
	[141904]	 = true, -- Battleground Victory Bonus - Level 110 PvP Reward
	[141905]	 = true, -- Battleground Victory Bonus - Level 110 PvP Reward
	[141899]	 = true, -- Battleground Victory Bonus - Level 110 PvP Reward
	[141901]	 = true, -- Battleground Victory Bonus - Level 110 PvP Reward
	[141902]	 = true, -- Arena Victory Bonus - Level 110 PvP Reward
	[141903]	 = true, -- Arena Victory Bonus - Level 110 PvP Reward
	[141906]	 = true, -- Arena Victory Bonus - Level 110 PvP Reward
	...
	[164257]	 = true, -- Cache of Uldir Treasures (Heroic)
	[164259]	 = true, -- Cache of Uldir Treasures (Mythic)
	[164260]	 = true, -- Cache of Uldir Treasures (Faid Finder)
	[165730]	 = true, -- Cache of Dazar'alor Treasures
	[165729]	 = true, -- Cache of Dazar'alor Treasures (Heroic)
	[165732]	 = true, -- Cache of Dazar'alor Treasures (Raid Finder)
	[165731]	 = true, -- Cache of Dazar'alor Treasures (Mythic)
	...
	[141350]	 = true, -- Kirin Tor Chest
	[153503]	 = true, -- Cache of Antoran Treasures (Mythic)
	[153504]	 = true, -- Cache of Antoran Treasures 
	[139484]	 = true, -- Cache of Nightmarish Treasures (Raid Finder)
	[140148]	 = true, -- Cache of Nightmarish Treasures (Raid Finder)
	[139488]	 = true, -- Cache of Nightmarish Treasures (Mythic)
	[140152]	 = true, -- Cache of Nightmarish Treasures (Heroic)
	[147518]	 = true, -- Cache of Fel Treasures (Raid Finder)
	[147519]	 = true, -- Cache of Fel Treasures 
	[147520]	 = true, -- Cache of Fel Treasures (Heroic)
	[147521]	 = true, -- Cache of Fel Treasures (Mythic)
	[153501]	 = true, -- Cache of Antoran Treasures (Heroic)
	[153502]	 = true, -- Cache of Antoran Treasures (Raid Finder)
	...
	[162611]	 = true, -- Seafarer's Coin Pouch
...
function KB:BANKFRAME_OPENED()
	atBank = true
end

function KB:BANKFRAME_CLOSED()
	atBank = false
end
...
function KB:MAIL_SHOW()
	atMail = true
end

function KB:MAIL_CLOSED()
	atMail = false
end

function KB:MERCHANT_SHOW()
	atMerchant = true
end

function KB:MERCHANT_CLOSED()
	atMerchant = false
end

function KB:BAG_UPDATE_DELAYED(bag)
	if not E.private.KlixUI.bags.autoOpen or (atBank or atMail or atMerchant) then return end
	for bag = 0, 4 do
		for slot = 0, T.GetContainerNumSlots(bag) do
			local id = T.GetContainerItemID(bag, slot)
			if id and autoOpenItems[id] then
				KUI:Print("|cffff0000Auto Use: " .. T.GetContainerItemLink(bag, slot))
			...
			--[[if GetMinimapZoneText() == "Salvage Yard" and id and autoOpenItemsSalvage[id] then
				KUI:Print:AddMessage("|cffff0000Auto Salvage : " .. T.GetContainerItemLink(bag, slot))
				T.UseContainerItem(bag, slot)
				return
			end]]
		end
