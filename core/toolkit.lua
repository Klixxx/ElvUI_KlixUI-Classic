...
T.C_AzeriteItem_GetAzeriteItemXPInfo = C_AzeriteItem.GetAzeriteItemXPInfo
...
T.C_Calendar_GetGuildEventInfo = C_Calendar.GetGuildEventInfo
T.C_Calendar_GetNumDayEvents = C_Calendar.GetNumDayEvents
T.C_Calendar_GetNumGuildEvents = C_Calendar.GetNumGuildEvents
...
T.C_CampaignInfo_GetCampaignInfo = C_CampaignInfo.GetCampaignInfo
T.C_CampaignInfo_GetCurrentCampaignID = C_CampaignInfo.GetCurrentCampaignID
T.C_ChallengeMode_GetActiveKeystoneInfo = C_ChallengeMode.GetActiveKeystoneInfo
T.C_ChallengeMode_GetAffixInfo = C_ChallengeMode.GetAffixInfo
T.C_ChallengeMode_GetCompletionInfo = C_ChallengeMode.GetCompletionInfo
T.C_ChatInfo_RegisterAddonMessagePrefix = C_ChatInfo.RegisterAddonMessagePrefix
T.C_ChatInfo_SendAddonMessage = C_ChatInfo.SendAddonMessage
T.C_Club_GetClubInfo = C_Club.GetClubInfo
T.C_Club_GetMessageInfo = C_Club.GetMessageInfo
...
T.C_EquipmentSet_GetEquipmentSetID = C_EquipmentSet.GetEquipmentSetID
T.C_EquipmentSet_GetEquipmentSetIDs = C_EquipmentSet.GetEquipmentSetIDs
T.C_EquipmentSet_GetEquipmentSetInfo = C_EquipmentSet.GetEquipmentSetInfo
T.C_EquipmentSet_GetItemLocations = C_EquipmentSet.GetItemLocations
T.C_EquipmentSet_GetNumEquipmentSets = C_EquipmentSet.GetNumEquipmentSets
T.C_EquipmentSet_SaveEquipmentSet = C_EquipmentSet.SaveEquipmentSet
T.C_EquipmentSet_UseEquipmentSet = C_EquipmentSet.UseEquipmentSet
...
T.C_Garrison_GetAvailableMissions = C_Garrison.GetAvailableMissions
T.C_Garrison_GetBasicMissionInfo = C_Garrison.GetBasicMissionInfo
T.C_Garrison_GetCompleteTalent = C_Garrison.GetCompleteTalent
T.C_Garrison_GetFollowerInfo = C_Garrison.GetFollowerInfo
T.C_Garrison_GetFollowerLink = C_Garrison.GetFollowerLink
T.C_Garrison_GetFollowerLinkByID = C_Garrison.GetFollowerLinkByID
T.C_Garrison_GetFollowers = C_Garrison.GetFollowers
T.C_Garrison_GetFollowerShipments = C_Garrison.GetFollowerShipments
T.C_Garrison_GetFollowerTypeByID = C_Garrison.GetFollowerTypeByID
T.C_Garrison_GetInProgressMissions = C_Garrison.GetInProgressMissions
T.C_Garrison_GetLandingPageShipmentInfoByContainerID = C_Garrison.GetLandingPageShipmentInfoByContainerID
T.C_Garrison_GetLooseShipments = C_Garrison.GetLooseShipments
...
T.C_Garrison_GetTalent = C_Garrison.GetTalent
T.C_Garrison_GetTalentTreeIDsByClassID = C_Garrison.GetTalentTreeIDsByClassID
T.C_Garrison_GetTalentTreeInfoForID = C_Garrison.GetTalentTreeInfoForID
T.C_Garrison_HasGarrison = C_Garrison.HasGarrison
T.C_Garrison_IsOnGarrisonMap = C_Garrison.IsOnGarrisonMap
T.C_Garrison_RequestLandingPageShipmentInfo = C_Garrison.RequestLandingPageShipmentInfo
T.C_Heirloom_IsItemHeirloom = C_Heirloom.IsItemHeirloom
T.C_Heirloom_PlayerHasHeirloom = C_Heirloom.PlayerHasHeirloom
...
T.C_LFGList_GetApplicantMemberInfo = C_LFGList.GetApplicantMemberInfo
...
T.C_NewItems_ClearAll = C_NewItems.ClearAll
T.C_NewItems_IsNewItem = C_NewItems.IsNewItem
T.C_PaperDollInfo_OffhandHasWeapon = C_PaperDollInfo.OffhandHasWeapon
T.C_PetBattles_CancelPVPDuel = C_PetBattles.CancelPVPDuel
T.C_PetBattles_IsInBattle = C_PetBattles.IsInBattle
T.C_PetJournal_FindPetIDByName = C_PetJournal.FindPetIDByName
T.C_PetJournal_GetNumCollectedInfo = C_PetJournal.GetNumCollectedInfo
T.C_PetJournal_GetPetInfoByIndex = C_PetJournal.GetPetInfoByIndex
T.C_PetJournal_GetPetInfoBySpeciesID = C_PetJournal.GetPetInfoBySpeciesID
T.C_PetJournal_SetAllPetSourcesChecked = C_PetJournal.SetAllPetSourcesChecked
T.C_PetJournal_SetAllPetTypesChecked = C_PetJournal.SetAllPetTypesChecked
T.C_PetJournal_SetFilterChecked = C_PetJournal.SetFilterChecked
T.C_QuestLine_GetQuestLineQuests = C_QuestLine.GetQuestLineQuests
T.C_QuestLog_IsOnQuest = C_QuestLog.IsOnQuest
...
T.C_Scenario_GetInfo = C_Scenario.GetInfo
T.C_Scenario_IsInScenario = C_Scenario.IsInScenario
T.C_Scenario_TreatScenarioAsDungeon = C_Scenario.TreatScenarioAsDungeon
T.C_ScrappingMachineUI_RemoveAllScrapItems = C_ScrappingMachineUI.RemoveAllScrapItems
T.C_SocialQueue_GetGroupMembers = C_SocialQueue.GetGroupMembers
T.C_SocialQueue_GetGroupQueues = C_SocialQueue.GetGroupQueues
T.C_SpecializationInfo_GetAllSelectedPvpTalentIDs = C_SpecializationInfo.GetAllSelectedPvpTalentIDs
T.C_SpecializationInfo_GetSpellsDisplay = C_SpecializationInfo.GetSpellsDisplay
T.C_TaskQuest_GetQuestInfoByQuestID = C_TaskQuest.GetQuestInfoByQuestID
T.C_TaskQuest_GetQuestsForPlayerByMapID = C_TaskQuest.GetQuestsForPlayerByMapID
T.C_TaskQuest_RequestPreloadRewardData = C_TaskQuest.RequestPreloadRewardData
T.C_TaxiMap_GetTaxiNodesForMap = C_TaxiMap.GetTaxiNodesForMap
T.C_Texture_GetAtlasInfo = C_Texture.GetAtlasInfo
T.C_Timer_After = C_Timer.After
T.C_Timer_NewTicker = C_Timer.NewTicker
T.C_ToyBox_IsToyUsable = C_ToyBox.IsToyUsable
T.C_TradeSkillUI_GetTradeSkillLineForRecipe = C_TradeSkillUI.GetTradeSkillLineForRecipe
T.C_TradeSkillUI_GetTradeSkillTexture = C_TradeSkillUI.GetTradeSkillTexture
T.C_Transmog_ClearPending = C_Transmog.ClearPending
T.C_Transmog_GetSlotInfo = C_Transmog.GetSlotInfo
T.C_Transmog_GetSlotVisualInfo = C_Transmog.GetSlotVisualInfo
T.C_Transmog_SetPending = C_Transmog.SetPending
T.C_TransmogCollection_GetAppearanceSourceInfo = C_TransmogCollection.GetAppearanceSourceInfo
T.C_TransmogCollection_GetAppearanceSources = C_TransmogCollection.GetAppearanceSources
T.C_TransmogCollection_GetCategoryAppearances = C_TransmogCollection.GetCategoryAppearances
T.C_TransmogCollection_GetIllusionSourceInfo = C_TransmogCollection.GetIllusionSourceInfo
T.C_TransmogCollection_GetItemInfo = C_TransmogCollection.GetItemInfo
T.C_TransmogCollection_GetSourceInfo = C_TransmogCollection.GetSourceInfo
T.C_VignetteInfo_GetVignetteInfo = C_VignetteInfo.GetVignetteInfo
T.C_WowTokenPublic_GetCurrentMarketPrice = C_WowTokenPublic.GetCurrentMarketPrice
T.C_WowTokenPublic_GetNumListedAuctionableTokens = C_WowTokenPublic.GetNumListedAuctionableTokens
T.C_WowTokenPublic_UpdateMarketPrice = C_WowTokenPublic.UpdateMarketPrice
